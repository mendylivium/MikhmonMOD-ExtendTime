	...
	<div class="row">
		...
		<div class="card">
              <div class="card-header"><h3>
				<i class="fa fa-user"></i> Revision Note</h3></div>
                <div class="card-body">
					Ang bersyon ng Mikhmon na ito ay may binago at ginawang mas simple para sa ibang tao, at ang ibang "function" ay galing pa rin sa orihinal na bersyon na gawa ni <i>Laksamadi</i><br/><br/>
					-Mendy
				</div>
			</div>
          </div>
      ...
      <div class="box bmh-75 box-bordered">
        ...
        <div class="row">
          <div  class="col-8">
            ...
            <div class="card">
              <div class="card-header"><h3><i class="fa fa-wifi"></i> Piso Wifi</h3></div>
                <div class="card-body">
                  <div class="row">
                    <div class="col-4 col-box-12">
                      <div class="box bg-blue bmh-75">
                        <a onclick="cancelPage()" href="./?hotspot=active&session=<?= $session; ?>">
                          ...
                          <div>
                            <i class="fa fa-laptop"></i> Connected
                          </div>
                        </a>
                      </div>
                    </div>
                      ...
                      <a onclick="cancelPage()" href="./?hotspot-user=generate&session=<?= $session; ?>">
                        <div>
                          <h1><i class="fa fa-user-plus"></i>
                              <span style="font-size: 15px;">Create</span>
                          </h1>
                        </div>
                        <div>
                            <i class="fa fa-user-plus"></i> Vouchers
                        </div>
                    </a>
                  </div>
                </div>
