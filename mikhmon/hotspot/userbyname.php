...
<form autocomplete="new-password" method="post" action="">
  <div>
    ...
    <a class="btn bg-secondary"  title="Print" href="javascript:window.open('./voucher/print.php?user=<?= $usermode . "-" . $uname; ?>&qr=no&session=<?= $session; ?>','_blank','width=310,height=450').print();"> <i class="fa fa-print"></i> Print Voucher</a>
    <a class="btn bg-info"  title="Print QR" href="javascript:window.open('./voucher/display.php?user=<?= $usermode . "-" . $uname; ?>&qr=yes&session=<?= $session; ?>','_blank','width=310,height=600');"> <i class="fa fa-qrcode"></i> Printer Less</a>
