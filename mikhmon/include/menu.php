...
<div id="sidenav" class="sidenav">
  ...
  <!--hotspot-->
  <div class="dropdown-btn <?= $susers . $suserprof . $sactive . $shosts . $sipbind . $scookies; ?>"><i class="fa fa-wifi"></i> Piso Wifi
    <i class="fa fa-caret-down"></i>
  </div>
  <div class="dropdown-container <?= $umenu . $upmenu . $hamenu . $hmenu . $ibmenu . $cmenu; ?>">
	   <!--users--> 
	  <div class="dropdown-btn <?= $susers; ?>"><i class="fa fa-ticket"></i> Vouchers
		<i class="fa fa-caret-down"></i>
	  </div>
	  <div class="dropdown-container <?= $umenu; ?>">
		<a href="./?hotspot=users&profile=all&session=<?= $session; ?>" class="<?= $susersl; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-list "></i> Voucher List </a>
		<a href="./?hotspot-user=generate&session=<?= $session; ?>" class="<?= $sgenuser; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-gear"></i> Generate Voucher </a>        
	  </div>
	  <!--profile-->
	  <div class="dropdown-btn <?= $suserprof; ?>"><i class=" fa fa-ticket"></i>  Voucher Profile
		<i class="fa fa-caret-down"></i>
	  </div>
	  ...
	  <!--active-->
	  <a href="./?hotspot=active&session=<?= $session; ?>" class="menu <?= $sactive; ?>"><i class=" fa fa-wifi"></i> Active User</a>
	  <!--hosts-->
  ...
  <!--report-->
  <a href="./?report=selling&idbl=<?= strtolower(date("M")) . date("Y"); ?>&session=<?= $session; ?>" class="menu <?= $sselling; ?>"><i class="nav-icon fa fa-money"></i> Sales Report</a>
  <!--settings-->
  ...
  <div class="dropdown-container <?= $settmenu; ?>" id="settmenu">
